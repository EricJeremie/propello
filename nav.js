...
export function initLayout({ activePage = '', onSettings = null } = {}) {
  ...
  sidebar.innerHTML = `
    <div class="app-sidebar__brand">
      ...
      <span class="app-sidebar__name">PocketDevs</span>
    </div>
    ...
    <nav class="app-sidebar__nav">
      <a href="dashboard.html" class="app-sidebar__item" data-page="dashboard">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>
        My Documents
      </a>
      <div class="app-sidebar__divider"></div>
      <a href="index.html" class="app-sidebar__item" data-page="proposal">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
        Proposal
      </a>
      <a href="index.html?mode=invoice" class="app-sidebar__item" data-page="invoice">
      ...
      <a href="requirements.html" class="app-sidebar__item" data-page="requirements">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>
        Requirements
      </a>
    </nav>
    <div class="app-sidebar__footer">
      <button id="sidebarSettingsBtn" type="button" class="app-sidebar__item" data-page="settings">
      ...
      <button id="sidebarLogoutBtn" type="button" class="app-sidebar__logout" hidden>
